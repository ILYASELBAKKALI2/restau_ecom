...
<head>
   ...
   <link rel="stylesheet" href="{{asset('assets/css/base.css')}}">
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Lobster&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css" crossorigin="anonymous"/>
    ...
    <main class="py-5">
        <div class="" >
            ...
            <div class="text-center">@include('layouts.alerts') </div>
                ...
                <div class="container bg-light py-5" style="min-height:50vh;border-radius:50px;box-shadow: 0 0 20px #000">
                ...
                <div class="row mt-3" style="font-family: 'Poppins">
                    
                    <div class="col-sm-6">
                        <img src="{{asset('assets/images/login_customer.png')}}" width="85%" height="100%" alt="">
                    </div>
                    <div class="col-sm-6" >
                 <form method="POST" action="{{ route('login') }}" class='mt-5' style="align-items:center;width:100%">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-4 offset-sm-4 text-center" style="padding: 2rem 1rem">
                            <button type="submit" class="" style="box-shadow: 0 0 10px #000;border: none;background-color:#ff9f03; padding: 10px 30px;border-radius:40px">

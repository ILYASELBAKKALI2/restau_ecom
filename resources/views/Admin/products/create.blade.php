  ...
  {{--<div class="row align-items-center">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 py-5" style="">
          <h2 class="text-center" style="font-size: 65px; font-family:'Great Vibes',cursive">Ajouter Produit</h2>
          <div class="text-center py-2">
            ...
            <div class="col-sm-11 " style="margin-left: 45px">
                  ...
                  <div style="">
                    <form action="{{route("products.store")}}" method="post" class="pt-2" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-8 offset-md-2 pb-2">
                                <input type="file" class="form-control contact-form-image" name="image" placeholder="Image">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <input type="name" name="name" class="form-control contact-form" id="" placeholder="Titre">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <input type="number" name="price" class="form-control contact-form" id="" placeholder="Prix">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <input type="number" name="old_price" class="form-control contact-form" id="" placeholder="Prix ancien">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <textarea class="form-control contact-form-textarea" name="details" id="" rows="4" placeholder="Details . . ."></textarea>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <select  name="category_id" class="contact-form" id="" placeholder="category_id">
                                    <option value="1" class="contact-form">
                                        Choisir une catégorie
                                    </option>
                                    @foreach ($categories as $category)
                                        <option value="{{$category->id}}" class="contact-form mt-2">
                                            {{$category->title}}
                                        </option> 
                                    @endforeach    
                                </select>

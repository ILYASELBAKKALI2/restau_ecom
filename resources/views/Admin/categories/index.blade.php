  ...
  {{--<div class="row align-items-center">
    ...
    <div class="row">
        ...
        <div class="col-sm-3" style="min-height: 110vh;background-color:rgba(10, 138, 106, 0.74)">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div>
          <form class="form-group d-flex pt-4 mb-5" id="search_product" action="{{route('categories.search')}}" method="GET">
            @csrf
            <input class="form-control me-2" style="width: 50vh" type="search" name="category" value="{{request()->input('category')}}" placeholder="Search" aria-label="Search">
        ...
        <div class="col-sm-9 py-5">
          <h2 class="text-center" style="font-size: 65px; font-family:'Great Vibes',cursive">Catégories</h2>
            ...
            <div class="col-sm-11 " style="margin-left: 45px">
              ...
              <div class="col-md-6 text-start">
                ...
                <div class="col-md-6 text-end">
                  <a href="{{route('categories.create')}}" class="btn" style="background-color:rgba(10, 138, 106, 0.74);color:#fff">Ajouter catégorie</a>
                </div>
          ...
          <div class="row">
              <table class="table  mt-2" style="box-shadow: 0 0 5px #000">
                  <thead>
                      <tr class="text-center" style="font-family:'Poppins';background-color: rgba(10,138,106,0.74);color:#fff">
                        <th>ID</th>  
                        <th>Image</th>
                        <th>Titre</th>
                        <th>Action</th>
                  ...
                  <tbody class="text-center" style="font-family:'Poppins';font-weight:500;border-bottom: 1px solid rgba(10,138,106,0.74)">
                    ...
                    <tr>
                        ...
                        <td><img src="{{asset($category->image)}}" width="70px" height="70px" alt=""></td>
                        <td>{{$category->title}}</td>
                      
                
                        <td>
                          <div class="d-flex justify-content-center">
                            <form action="{{ route('categories.destroy',$category->title) }}" id="{{ $category->id }}" method="POST">
                              @csrf
                              @method("DELETE")
                              <button type="submit" class="mx-1 btn btn-sm btn-outline-danger fas fa-trash"
                                onclick="event.preventDefault();
                                  if(confirm('Voulez vous vraiment supprimer {{$category->title}} ?'))
                                  document.getElementById('{{$category->id}}').submit();"
                              ></button>
                            </form>
                         
                            <a href="{{ route('categories.edit',$category->title) }}" class="btn btn-sm btn-outline-warning fas fa-edit"></a>
                          </div>
                        </td>
            ...
            <div class="row mt-2">
              <div class="col-sm-12  d-flex justify-content-center" style="outline: none">{{$A_categories->links()}}</div>

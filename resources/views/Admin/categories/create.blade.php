    ...
    <div class="row">
      ...
      <div class="col-sm-3" style="height: 110vh;background-color:rgba(10, 138, 106, 0.74)">
        ...
        <div class="col-sm-9 py-5" style="">
          <h2 class="text-center" style="font-size: 65px; font-family:'Great Vibes',cursive">Ajouter catégorie</h2>
            ...
            <div class="col-sm-11 " style="margin-left: 45px">
                  <div style="margin-top: 5vh;margin-bottom:5vh">
                    <form action="{{route("categories.store")}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-md-2 py-3">
                                <input type="text" name="title" class="form-control contact-form" id="" placeholder="Titre">
                            </div>
                        </div>
